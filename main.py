...
def start1(update: Update, context: CallbackContext) -> int:
    ...
    reply_keyboard = [['Летние принадлежности 🤿', 'Каталог мебели 🪑', 'Бесплатная доставка 📦']]
...
def main() -> None:
    ...
    updater = Updater("2029998715:AAHzPS9lZvv4u_xFvJNZsLBRqUjQc1v9SyE", use_context=True)
    ...
    conv_handler = ConversationHandler(
        ...
        states={
            ...
            MESSAGE1: [MessageHandler(Filters.regex('^(Летние принадлежности 🤿|Каталог мебели 🪑|Бесплатная доставка 📦)$'), message_2)],
        },
